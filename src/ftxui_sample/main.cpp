...
// configuration step. It creates a namespace called `concurrency_practice`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", concurrency_practice::cmake::project_name, concurrency_practice::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", concurrency_practice::cmake::project_version);
      return EXIT_SUCCESS;
    }
